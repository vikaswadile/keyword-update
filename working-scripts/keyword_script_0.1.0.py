...
db_params_source = {
    ...
    "database": "postgres",
    "user": "postgres",
    "password": getpass("Enter the source database password: "),
}
...
db_params_target = {
    ...
    "user": "postgres",
    "password": getpass("Enter the target database password: "),
}
...
try:
    ...
    # Get the new value to add to location_keyword
    new_value = input("Enter the new value to add to location_keyword: ")
